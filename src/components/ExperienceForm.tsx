...
const ExperienceForm = () => {
  ...
  return (
    <div className="relative">
      {/* Overlay com blur quando um campo está focado */}
      {focusedField && (
        <div className="fixed inset-0 bg-black/20 backdrop-blur-sm z-10 pointer-events-none" />
      )}
      
      <Card className={`relative ${focusedField ? 'z-20' : ''}`}>
        <CardHeader>
            ...
            <div 
              ...
              className={`border rounded-lg p-4 space-y-4 transition-all duration-300 ${
                focusedField?.startsWith(exp.id) 
                  ? 'shadow-2xl ring-2 ring-primary/50 bg-background z-30 relative' 
                  : focusedField 
                    ? 'opacity-30' 
                    : 'hover:shadow-md'
              }`}
            >
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <Input
                    ...
                    onFocus={() => setFocusedField(`${exp.id}-position`)}
                    onBlur={() => setFocusedField(null)}
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <Input
                    ...
                    onFocus={() => setFocusedField(`${exp.id}-startDate`)}
                    onBlur={() => setFocusedField(null)}
                ...
                <div>
                  ...
                  <Input
                    ...
                    onFocus={() => setFocusedField(`${exp.id}-endDate`)}
                    onBlur={() => setFocusedField(null)}
              ...
              <div>
                ...
                <Textarea
                  ...
                  onFocus={() => setFocusedField(`${exp.id}-problem`)}
                  onBlur={() => setFocusedField(null)}
              ...
              <div>
                ...
                <Textarea
                  ...
                  onFocus={() => setFocusedField(`${exp.id}-solution`)}
                  onBlur={() => setFocusedField(null)}
              ...
              <div>
                ...
                <Input
                  ...
                  onFocus={() => setFocusedField(`${exp.id}-technologies`)}
                  onBlur={() => setFocusedField(null)}
              ...
              <div>
                ...
                <Textarea
                  ...
                  onFocus={() => setFocusedField(`${exp.id}-impact`)}
                  onBlur={() => setFocusedField(null)}
